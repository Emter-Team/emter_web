...
export default function GetOfficersInstitution() {
    ...
    const getOfficers = async (page) => {
        ...
        setTimeout(async () => {
            try {
                const response = await http.get("/institution/officers/", {
                    params,
                });
    ...
    const handleTrash = (username) => {
        ...
        setTimeout(async () => {
            try {
                await http.delete(`/institution/officers/${username}`);
                setIsDeleteToast(false);
                    ...
                    <div className="w-full flex flex-col justify-center md:flex-row md:justify-end">
                        <div className="title w-full md:w-1/3">
                            ...
                            <p className="text-secondary">
                                Daftar semua petugas yang telah didaftarkan di
                                Instansi
                            </p>
                        </div>
